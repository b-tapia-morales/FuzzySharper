...
public interface IRule
{
    ...
    IRule Then(ILinguisticBase linguisticBase, string variableName, string termName, HedgeType hedgeType = HedgeType.None);

    IRule Then(string variableName, string termName, HedgeType hedgeType = HedgeType.None);
